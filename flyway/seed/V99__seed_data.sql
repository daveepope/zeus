...
SELECT event_type_id INTO v_event_type_id FROM sensor_event_types WHERE type_name = 'MEASUREMENT';
...
INSERT INTO sensor_events (sensor_id, event_type_id, event_timestamp)
VALUES (v_sensor_id, v_event_type_id, NOW() - INTERVAL '15 minutes')
...
INSERT INTO sensor_events (sensor_id, event_type_id, event_timestamp)
VALUES (v_sensor_id, v_event_type_id, NOW() - INTERVAL '3 minutes')
...
-- Insert Event
INSERT INTO sensor_events (sensor_id, event_type_id, event_timestamp)
VALUES (v_sensor_id, v_event_type_id, NOW() - INTERVAL '2 minutes')
    RETURNING event_id INTO v_event_id_1;
